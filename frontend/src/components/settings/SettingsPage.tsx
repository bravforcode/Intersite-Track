...
import { Plus, Edit3, Trash2, X, CheckCircle2, Settings, Tag, ArrowLeftRight, FileText, ClipboardList, LayoutTemplate } from "lucide-react";
...
export function SettingsPage({ refreshTrigger = 0 }: SettingsPageProps) {
  ...
  const [tab, setTab] = useState<"departments" | "taskTypes" | "templates" | "trello" | "trelloLogs" | "auditLogs" | "systemInfo">("departments");
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-6">
      ...
      <div className="flex gap-2 flex-wrap">
        ...
        {tabBtn("templates", <LayoutTemplate size={16} className="inline mr-2" />, "Template")}
