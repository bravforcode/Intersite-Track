...
![RBAC](https://img.shields.io/badge/Enterprise-RBAC_%2B_Audit-0ea5e9?style=for-the-badge)

> **Enterprise-grade task & project management** — role-based access control, audit trails, cross-team tracking.

### Demo

![Demo](https://via.placeholder.com/1280x640/0f172a/38bdf8?text=Intersite-Track+—+Enterprise+PM+Demo+—+Add+docs/demo.gif)

### Architecture

```mermaid
graph TD
  A[React 19 SPA] --> B[Express API]
  B --> C[RBAC Middleware]
