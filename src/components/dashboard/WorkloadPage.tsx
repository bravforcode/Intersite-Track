...
import { 
  UsersIcon, ClipboardListIcon, AlertTriangleIcon, 
  CheckCircle2Icon, BriefcaseIcon, ShieldAlertIcon 
} from "lucide-react";
        ...
        <Card className="bg-red-50 border-red-100">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-3xl font-bold text-red-900">{reports.reduce((acc, r) => acc + r.overdue, 0)}</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="bg-orange-50 border-orange-100">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-3xl font-bold text-orange-900">{reports.reduce((acc, r) => acc + r.blocked, 0)}</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="bg-blue-50 border-blue-100">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-3xl font-bold text-blue-900">{reports.reduce((acc, r) => acc + r.completed, 0)}</p>
            </div>
          </div>
        </Card>
      </div>
