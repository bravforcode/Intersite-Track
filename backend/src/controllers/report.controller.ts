...
export async function getAnalyticsHandler(_req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
...
export async function getStaffReportHandler(_req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
...
export async function exportCsvReport(_req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
...
export async function exportPdfReport(_req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    const tasks = await findAllTasks();
...
export async function exportStaffPdfReport(_req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
